...
ax.set_title(r'\textbf{(c)}', position=(0.1,0.9), fontsize=font_size_2)
...
ax.set_zlabel(r'$V$',fontsize=font_size_2)
# ax.legend()
plt.subplots_adjust(left=0.0, bottom=0.1, right=0.85, top=0.98, wspace=0.15, hspace=0.15)
...
ax.set_xlabel(r'$s_1$',fontsize=font_size_2)
ax.set_ylabel(r'$s_2$',fontsize=font_size_2,rotation=0)
ax.set_title(r'\textbf{(c)}', position=(-0.25,0.85), fontsize=font_size_2)
ax.set_xlim([-0.16, 0.05])
ax.set_ylim([-0.71, 0.1])
ax.plot(posl[:,0], posl[:,1],color='b')
posl_ = posl[::10]
...
ax.set_xlabel(r'$s_1$',fontsize=font_size_2)
ax.set_ylabel(r'$s_2$',fontsize=font_size_2,rotation=0)
ax.set_title(r'\textbf{(d)}', position=(-0.25,0.85), fontsize=font_size_2)
ax.set_xlim([-0.16, 0.05])
ax.set_ylim([-0.71, 0.1])
ax.plot(posl[:,0], posl[:,1],color='b')
posl_ = posl[::10]
...
# plt.show(block=True)
fig.savefig("pos2_energy_rss.pdf")
