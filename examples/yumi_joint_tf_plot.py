...
base_tf_filename = '/home/shahbaz/Software/garage/examples/tf/data/local/exp'
exp_name ='ppo_yumi_peg'
filename = base_tf_filename + '/' + exp_name + '/' + 'exp_log.pkl'
...
for ep in range(epoch_num):
    ...
    for s in range(sample_num):
        success_mat[ep, s] = np.min(np.linalg.norm(epoch[s]['observations'] - GOAL)) < SUCCESS_DIST
